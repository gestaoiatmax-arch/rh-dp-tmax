...
```sql
insert into perfis (id, nome_completo, cargo_no_sistema)
...
3. Em **Environment Variables**, adicione:
   - `NEXT_PUBLIC_SUPABASE_URL` = `https://crjuywenyhfeymmhcasj.supabase.co`
   - `NEXT_PUBLIC_SUPABASE_ANON_KEY` = (a publishable key que você já tem)
